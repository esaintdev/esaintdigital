...
const HeroOne = () => {
  return (
    <div
      ...
      id="hero"
      style={{ backgroundImage: "url(assets/img/hero/banner-bg.jpg)" }}
    >
            ...
            <div className="hero-style1">
              ...
              <div className="btn-group">
                <Link to="/about" className="global-btn">
                  Learn More <img src="assets/img/icon/right-icon.svg" alt="Gohub" />
                </Link>
        ...
        <div className="hero-item-content">
          <div className="hero-card_wrapper">
            ...
            <div className="hero-card">
              ...
              <div className="hero-card_content">
                <h4 className="box-title">Growth Acceler</h4>
                <p className="hero-card_text">Consultant professional</p>
              </div>
            </div>
          </div>
        </div>
